...
abstract class $RecordCopyWith<$Res> {
  ...
  $Res call({int weight, DateTime dateTime, String? note, String? imgUrl});
}
...
class _$_Record implements _Record {
  _$_Record(
      {required this.weight, required this.dateTime, this.note, this.imgUrl});
  ...
  @override
  String toString() {
    return 'Record(weight: $weight, dateTime: $dateTime, note: $note, imgUrl: $imgUrl)';
  }
